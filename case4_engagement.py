...
# 2. Yearly growth of registered users nationwide
Q2 = """
...
# 3. Quarterly trend of app opens in the top state
Q3 = """
WITH top_state AS (
    SELECT state
    FROM aggregated_user
...
# 5. Engagement ratio: App Opens / Registered Users (latest year, per state)
Q5 = """
SELECT state, 
